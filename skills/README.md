...
Skills are small, reusable operating guides for recurring tasks.

Each skill should live in its own folder and usually include:

- `SKILL.md` with trigger conditions, workflow, and expected outputs
